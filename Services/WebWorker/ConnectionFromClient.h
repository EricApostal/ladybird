...
private:
    ...
    virtual void start_service_worker(URL::URL script_url, Web::Bindings::WorkerType worker_type, Web::HTML::SerializedEnvironmentSettingsObject outside_settings) override;
    virtual void dispatch_extendable_event(String event_name) override;
