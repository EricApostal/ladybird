...
libweb_js_bindings(Animations/Animatable)
...
libweb_js_bindings(Animations/ScrollTimeline)
libweb_js_bindings(ARIA/ARIAMixin)
...
libweb_js_bindings(CSS/CSSFontFeatureValuesRule)
libweb_js_bindings(CSS/CSSFunctionDeclarations)
libweb_js_bindings(CSS/CSSFunctionDescriptors)
libweb_js_bindings(CSS/CSSFunctionRule)
...
libweb_js_bindings(CSS/CSSMatrixComponent)
...
libweb_js_bindings(CSS/CSSScopeRule)
...
libweb_js_bindings(CSS/ElementCSSInlineStyle)
libweb_js_bindings(CSS/FontFace)
libweb_js_bindings(CSS/FontFaceSet)
libweb_js_bindings(CSS/FontFaceSetLoadEvent)
libweb_js_bindings(CSS/GeneratedCSSNumericFactoryMethods)
libweb_js_bindings(CSS/GeneratedCSSStyleProperties)
libweb_js_bindings(CSS/LinkStyle)
...
libweb_js_bindings(DOM/DocumentOrShadowRoot)
...
libweb_js_bindings(DOM/EventHandler)
libweb_js_bindings(DOM/EventListener)
...
libweb_js_bindings(DOMURL/URLSearchParams)
libweb_js_bindings(Encoding/TextDecoder)
libweb_js_bindings(Encoding/TextDecoderCommon)
libweb_js_bindings(Encoding/TextDecoderStream)
libweb_js_bindings(Encoding/TextEncoder)
libweb_js_bindings(Encoding/TextEncoderCommon)
...
libweb_js_bindings(Fetch/Body)
libweb_js_bindings(Fetch/BodyInit)
libweb_js_bindings(Fetch/Headers)
...
libweb_js_bindings(Fullscreen/DocumentExtensions)
libweb_js_bindings(Fullscreen/DocumentOrShadowRootExtensions)
libweb_js_bindings(Fullscreen/ElementExtensions)
...
libweb_js_bindings(GPC/GlobalPrivacyControl)
libweb_js_bindings(HighResolutionTime/DOMHighResTimeStamp)
libweb_js_bindings(HighResolutionTime/EpochTimeStamp)
libweb_js_bindings(HighResolutionTime/Performance)
libweb_js_bindings(HTML/AbstractWorker)
libweb_js_bindings(HTML/AnimationFrameProvider)
...
libweb_js_bindings(HTML/Canvas/CanvasCompositing)
libweb_js_bindings(HTML/Canvas/CanvasDrawImage)
libweb_js_bindings(HTML/Canvas/CanvasDrawPath)
libweb_js_bindings(HTML/Canvas/CanvasFillStrokeStyles)
libweb_js_bindings(HTML/Canvas/CanvasFilters)
libweb_js_bindings(HTML/Canvas/CanvasImageData)
libweb_js_bindings(HTML/Canvas/CanvasImageSmoothing)
libweb_js_bindings(HTML/Canvas/CanvasPath)
libweb_js_bindings(HTML/Canvas/CanvasPathDrawingStyles)
libweb_js_bindings(HTML/Canvas/CanvasRect)
libweb_js_bindings(HTML/Canvas/CanvasSettings)
libweb_js_bindings(HTML/Canvas/CanvasShadowStyles)
libweb_js_bindings(HTML/Canvas/CanvasState)
libweb_js_bindings(HTML/Canvas/CanvasText)
libweb_js_bindings(HTML/Canvas/CanvasTextDrawingStyles)
libweb_js_bindings(HTML/Canvas/CanvasTransform)
libweb_js_bindings(HTML/Canvas/CanvasUserInterface)
libweb_js_bindings(HTML/Canvas/OffscreenCanvasBase)
...
libweb_js_bindings(HTML/CanvasRenderingContext2DSettings)
...
libweb_js_bindings(HTML/DedicatedWorkerGlobalScope)
...
libweb_js_bindings(HTML/External)
...
libweb_js_bindings(HTML/HTMLHyperlinkElementUtils)
...
libweb_js_bindings(HTML/HTMLOrSVGOrMathMLElement)
...
libweb_js_bindings(HTML/HTMLSelectedContentElement)
...
libweb_js_bindings(HTML/HyperlinkElementUtils)
libweb_js_bindings(HTML/ImageBitmap)
libweb_js_bindings(HTML/ImageBitmapRenderingContext)
...
libweb_js_bindings(HTML/NavigationType)
libweb_js_bindings(HTML/Navigator)
libweb_js_bindings(HTML/NavigatorBeacon)
libweb_js_bindings(HTML/NavigatorConcurrentHardware)
libweb_js_bindings(HTML/NavigatorDeviceMemory)
libweb_js_bindings(HTML/NavigatorID)
libweb_js_bindings(HTML/NavigatorLanguage)
libweb_js_bindings(HTML/NavigatorOnLine)
...
libweb_js_bindings(HTML/PopoverTargetAttributes)
libweb_js_bindings(HTML/PopStateEvent)
libweb_js_bindings(HTML/PredefinedColorSpace)
...
libweb_js_bindings(HTML/SharedWorkerGlobalScope)
...
libweb_js_bindings(HTML/UniversalGlobalScope)
...
libweb_js_bindings(HTML/WindowDeprecated)
libweb_js_bindings(HTML/WindowLocalStorage)
libweb_js_bindings(HTML/WindowOrWorkerGlobalScope)
libweb_js_bindings(HTML/WindowSessionStorage)
...
libweb_js_bindings(Internals/FakeXRDevice)
...
libweb_js_bindings(Internals/XRTest)
...
libweb_js_bindings(MathML/MathMLAnchorElement)
...
libweb_js_bindings(MediaCapture/MediaStreamConstraints)
...
libweb_js_bindings(NavigationTiming/PerformanceExtensions)
...
libweb_js_bindings(PermissionsAPI/Permissions)
libweb_js_bindings(PermissionsAPI/PermissionStatus)
libweb_js_bindings(RequestIdleCallback/IdleDeadline)
libweb_js_bindings(RequestIdleCallback/IdleRequest)
...
libweb_js_bindings(ServiceWorker/Cache)
libweb_js_bindings(ServiceWorker/CacheStorage)
libweb_js_bindings(ServiceWorker/Clients)
libweb_js_bindings(ServiceWorker/ExtendableEvent)
libweb_js_bindings(ServiceWorker/ServiceWorker)
libweb_js_bindings(ServiceWorker/ServiceWorkerContainer)
libweb_js_bindings(ServiceWorker/ServiceWorkerGlobalScope)
libweb_js_bindings(ServiceWorker/ServiceWorkerRegistration)
libweb_js_bindings(Speech/SpeechGrammar)
libweb_js_bindings(Speech/SpeechGrammarList)
libweb_js_bindings(Speech/SpeechRecognition)
libweb_js_bindings(Speech/SpeechRecognitionAlternative)
libweb_js_bindings(Speech/SpeechRecognitionEvent)
libweb_js_bindings(Speech/SpeechRecognitionPhrase)
libweb_js_bindings(Speech/SpeechRecognitionResult)
libweb_js_bindings(Speech/SpeechRecognitionResultList)
libweb_js_bindings(Speech/SpeechSynthesis)
libweb_js_bindings(Speech/SpeechSynthesisUtterance)
libweb_js_bindings(Speech/SpeechSynthesisVoice)
libweb_js_bindings(StorageAPI/NavigatorStorage)
...
libweb_js_bindings(Streams/QueuingStrategy)
libweb_js_bindings(Streams/QueuingStrategyInit)
...
libweb_js_bindings(Streams/ReadableStreamGenericReader)
libweb_js_bindings(Streams/Transformer)
libweb_js_bindings(Streams/TransformStream)
libweb_js_bindings(Streams/TransformStreamDefaultController)
libweb_js_bindings(Streams/UnderlyingSink)
libweb_js_bindings(Streams/UnderlyingSource)
...
libweb_js_bindings(SVG/SVGFEDisplacementMapElement)
libweb_js_bindings(SVG/SVGFEDropShadowElement)
...
libweb_js_bindings(SVG/SVGFilterPrimitiveStandardAttributes)
libweb_js_bindings(SVG/SVGFitToViewBox)
...
libweb_js_bindings(SVG/SVGPatternElement)
...
libweb_js_bindings(SVG/SVGSwitchElement)
...
libweb_js_bindings(SVG/SVGURIReference)
...
libweb_js_bindings(UIEvents/EventModifier)
...
libweb_js_bindings(UIEvents/PointerEventHandlers)
...
libweb_js_bindings(WebLocks/Lock)
libweb_js_bindings(WebLocks/LockManager)
libweb_js_bindings(WebLocks/NavigatorLocks)
...
libweb_js_bindings(WebAssembly/WebAssembly)
...
libweb_js_bindings(WebGL/Extensions/WebGLDebugRendererInfo)
libweb_js_bindings(WebGL/Extensions/WebGLDrawBuffers)
libweb_js_bindings(WebGL/Extensions/WebGLVertexArrayObjectOES)
libweb_js_bindings(WebGL/Types)
libweb_js_bindings(WebGL/WebGL2RenderingContext)
libweb_js_bindings(WebGL/WebGL2RenderingContextBase)
libweb_js_bindings(WebGL/WebGL2RenderingContextOverloads)
...
libweb_js_bindings(WebGL/WebGLRenderingContextBase)
libweb_js_bindings(WebGL/WebGLRenderingContextOverloads)
libweb_js_bindings(WebGL/WebGLSampler)
libweb_js_bindings(WebGL/WebGLShader)
libweb_js_bindings(WebGL/WebGLShaderPrecisionFormat)
libweb_js_bindings(WebGL/WebGLSync)
...
libweb_js_bindings(WebIDL/Buffers)
libweb_js_bindings(WebIDL/DOMException)
libweb_js_bindings(WebIDL/Function)
libweb_js_bindings(WebIDL/QuotaExceededError)
libweb_js_bindings(WebSockets/WebSocket)
libweb_js_bindings(WebVTT/VTTCue)
libweb_js_bindings(WebVTT/VTTRegion)
libweb_js_bindings(WebXR/XRLayer)
libweb_js_bindings(WebXR/XRRenderState)
libweb_js_bindings(WebXR/XRSession)
libweb_js_bindings(WebXR/XRSessionEvent)
libweb_js_bindings(WebXR/XRSystem)
libweb_js_bindings(WebXR/XRWebGLLayer)
...
libweb_js_bindings(XPath/XPathNSResolver)
